...
const upsert_biometric_dto_1 = require("./dto/upsert-biometric.dto");
...
let UsersController = class UsersController {
    ...
    findAll(req, activeOnly) {
        return this.usersService.findContactsForAccount(req.user.sub, req.user.role, activeOnly === 'true');
    }
    findOne(req, id) {
...
__decorate([
    (0, common_1.Get)(':id/biometric-profile'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "getBiometric", null);
__decorate([
    (0, common_1.Post)(':id/biometric-profile'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, upsert_biometric_dto_1.UpsertBiometricProfileDto]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "upsertBiometric", null);
